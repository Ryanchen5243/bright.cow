...
type ComboboxAnchorContextValue = {
...
function Combobox(
  ...
  return (
    <ComboboxAnchorContext.Provider value={contextValue}>
...
function ComboboxInput({
  ...
  const anchorContext = React.useContext(
    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          style={{
            /*
             * Base UI normally supplies --anchor-width.
             * The fallback prevents the popup from collapsing
             * to the width of the arrow button.
             */
            width: "var(--anchor-width, 20rem)",
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        "px-2.5 py-1.5 text-sm shadow-xs",
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "flex h-[calc(--spacing(5.5))] w-fit",
        "items-center justify-center gap-1",
        "rounded-sm bg-muted px-1.5",
...
/*
 * This helper remains available for cases where you
 * deliberately want to provide a custom anchor.
 */
